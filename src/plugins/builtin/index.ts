...
// in every build, and unconditionally — the plugin API is their integration surface,
// not a trust boundary — because they are app code: shipping in the bundle, reviewed
// like any other
