...
const PENDING: Record<string, string> = {
  ...
  "src/components/layout/FileEditorLayout.tsx": "Task 5",
  "src/components/layout/StatusBar.tsx": "Task 7",
  "src/components/layout/TabBar.tsx": "Task 5",
  "src/components/layout/TabSwitcher.tsx": "Task 5",
  ...
  "src/components/toolbar/BlockHandleMenu.tsx": "Task 2",
  "src/components/toolbar/context-menu-math.ts": "Task 2",
  "src/components/toolbar/context-menu-table.ts": "Task 2",
