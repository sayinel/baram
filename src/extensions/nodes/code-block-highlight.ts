...
export const lightHighlightStyle = HighlightStyle.define([
  ...
  { tag: [tags.name, tags.deleted, tags.character, tags.macroName], color: "#30a" },
  { tag: [tags.propertyName], color: "#00c" },
  { tag: [tags.processingInstruction, tags.string, tags.inserted, tags.special(tags.string)], color: "#a11" },
  { tag: [tags.function(tags.variableName), tags.labelName], color: "#30a" },
  { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: "#219" },
  { tag: [tags.definition(tags.name), tags.separator], color: "#00c" },
  { tag: [tags.className], color: "#167" },
  { tag: [tags.number, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: "#256" },
