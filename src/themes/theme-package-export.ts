 ...
 * round 1, Finding 3). 이 문단이 다시 쓰인 것은, fix round 1 이 여기 남긴 "두지 않는다"는
 * 문구가 바로 아래 `">=0.0.0"` 대입과 모순돼 보인다는 것을 final review 가 잡았기
 * 때문이다. 실측: `git tag --contains e07eeb44`(§360 커밋,
