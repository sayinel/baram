...
- **Phase 3 (고급 기능)** — 진행 중
  ...
  - 🚢 **미발행** — `v0.7.1..main` 135커밋: 폰트 시스템 **§346–§354**(번들 서체·서체 브라우저·
    export 반출), 기능 토글 UI 가시성 **§337–§345**, OpenRouter 프로바이더 **§6.3**,
