...
> 선행 분석: [`docs/impl-notes/large-file-performance.md`](../impl-notes/large-file-performance.md) (Phase A/B/C 로드맵)
...
- 선행 분석/로드맵: `docs/impl-notes/large-file-performance.md`
- 성능 목표 원본: CLAUDE.md §8.4 / `docs/design/part8-roadmap.md`
