...
**Design doc:** `docs/plans/2026-03-15-design-token-system.md`
...
- `docs/plans/2026-03-15-design-token-system.md` (approved design)
...
If ANY visual diff is detected, it must be documented in `docs/plans/migration-report.md` with:
- Component name
- What changed
...
**Files:**
- Create: `docs/plans/token-rename-map.md`
...
**Files:**
- Create: `docs/plans/migration-report.md`
...
- Document decisions in `docs/plans/migration-report.md`
...
- [ ] `src/App.css` deleted
- [ ] `docs/plans/migration-report.md` complete
