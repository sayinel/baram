...
**Design doc:** [`docs/plans/2026-06-09-large-file-perf-design.md`](./2026-06-09-large-file-perf-design.md)
...
| `docs/impl-notes/large-file-perf-baseline.md` | Phase 0 baseline numbers (new results doc) | Create |
...
**Files:**
- Create: `docs/impl-notes/large-file-perf-baseline.md`

- [ ] **Step 1: Write the baseline doc**

Create `docs/impl-notes/large-file-perf-baseline.md` with the measured numbers:
...
```bash
git add src/styles/editor.css docs/impl-notes/large-file-perf-baseline.md
...
```bash
git add src/extensions/nodes/views/code-block-node-view.ts src/extensions/nodes/views/__tests__/code-block-lazy.test.ts src/styles/editor.css docs/impl-notes/large-file-perf-baseline.md
