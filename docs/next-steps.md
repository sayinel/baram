...
| Phase 2 | M9 (인라인 마크+TOC+테이블 Tier 3+글로벌 검색+정의 목록+Mermaid 고도화+Git Basic) | 9 | ✅ 완료 (2026-02-25) |
| Phase 2 | M9 (나머지) | 5 | 3 완료 (§54, §52, §53), 2 미착수 |
| Phase 3 | M10 | 17 | 미착수 |

전체 98개 기능 중 79개 완료 (80.6%), 19개 남음 (19.4%).

---

## M9 — Productivity Tools (5개 남음)

| 우선순위 | 기능 | 설명 | 비고 |
|---------|------|------|------|
| ~~높음~~ | ~~**§50 Mermaid Diagrams (고도화)**~~ | ~~11종 다이어그램, 소스 편집 + 라이브 프리뷰~~ | ✅ 완료 (2026-02-25) |
| ~~높음~~ | ~~**§51 Global Search (Cmd+Shift+F)**~~ | ~~tantivy 전문검색, regex, 파일/폴더 필터, Replace~~ | ✅ 완료 (2026-02-25) |
| ~~중간~~ | ~~**§57b Git Basic**~~ | ~~status, commit, diff, branch switching, 사이드바~~ | ✅ 완료 (2026-02-25) |
| ~~중간~~ | ~~**§54 Theme System**~~ | ~~CSS 커스텀 테마, 테마 갤러리~~ | ✅ 완료 (2026-02-25) |
| ~~중간~~ | ~~**§52 Workspace Presets**~~ | ~~Writing/Skills/Research 프리셋 + 커스텀~~ | ✅ 완료 (2026-02-27) |
| ~~중간~~ | ~~**§53 Export for Notion**~~ | ~~Baram→Notion 호환 마크다운 변환~~ | ✅ 완료 (2026-02-27) |
...
| ~~**§71 File Snapshots / Version History**~~ | ~~타임머신 스타일 파일 버저닝~~ ✅ 완료 (2026-03-07) |
...
2. ~~**Git Basic (§57b)**~~ — ✅ 완료
3. ~~**Theme System (§54)**~~ — ✅ 완료
4. ~~**나머지 M9 기능들**~~ — §52, §53 완료, §55/§56/§57 미착수
