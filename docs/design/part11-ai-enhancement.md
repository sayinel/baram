...
| 파일 | 변경 내용 |
|------|-----------|
| `src-tauri/src/llm/mod.rs` | privacy_mode=true 시 각 provider에 no-store 헤더 추가 |
...
| `src-tauri/src/commands/embedding_cmd.rs` | IPC 커맨드 (embed_text, search_knowledge, index_status) |
