...
export const MESSAGES = {
  en: {
    ...
    "install.note": "First launch: if macOS shows a \"damaged\" warning, choose Open Anyway under Privacy & Security; if Windows SmartScreen blocks the app, choose More info → Run anyway.",
  ...
  ko: {
    ...
    "install.note": "첫 실행 시: macOS에서 \"손상됨\" 경고가 뜨면 개인정보 보호 및 보안에서 '그대로 열기'를, Windows SmartScreen이 차단하면 '추가 정보 → 실행'을 선택하세요.",
