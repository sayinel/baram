...
export const MESSAGES = {
  ...
  ko: {
    ...
    "features.plugins.d": "내장 마켓플레이스에서 커뮤니티 플러그인을 설치하거나, 플러그인 API로 직접 만들어 보세요.",
    ...
    "plugins.desc": "내장 마켓플레이스에서 커뮤니티 플러그인을 찾아보세요 — 테마, 도구, 에디터 확장을 클릭 한 번으로 설치합니다. 직접 만들고 싶다면 개발 가이드로 시작하세요.",
    ...
    "faq.a5": "네. 설정 > 키바인딩에서 카테고리별로 정리된 모든 단축키를 확인하고, Edit을 눌러 새 키 조합을 지정할 수 있습니다.",
    "faq.q6": "어떤 언어를 지원하나요?",
    "faq.a6": "현재 영어와 한국어 UI를 지원합니다 — 메뉴, 대화상자, 설정, 시작 화면까지 전부.",
    "faq.seeAll": "모든 질문 보기 →",
