...
**Design spec:** `dev/design/part13-zettelkasten-space.md` §95 (resolver requirement) + §13.10 (Rust). Frontend live-title/autocomplete/B2/New-from-selection/export are Plan 2b-ii. Prereq: Plan 2a landed (notes are `notes/{id} {title}.md` / `inbox/{id}.md`; links will be `[[ID]]`).
