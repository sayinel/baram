...
**Design sources:**
- [`dev/impl-notes/large-file-perf-baseline.md`](../impl-notes/large-file-perf-baseline.md) — "Post-C2 GUI verification (2026-06-11)" (symptoms + gate decision)
- C2 plan: [`dev/plans/2026-06-10-large-file-perf-c2-plan.md`](2026-06-10-large-file-perf-c2-plan.md) (progressive-load machinery this plan builds on)
...
| `dev/impl-notes/large-file-perf-baseline.md` | record all measurements | Modify (C3.0/C3.6) |
