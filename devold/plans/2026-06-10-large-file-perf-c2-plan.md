...
**Design source:** [`dev/impl-notes/large-file-perf-baseline.md`](../impl-notes/large-file-perf-baseline.md) (Post-Phase-1 GUI measurement → C2 gate decision).
...
**Files:**
- Modify: `dev/impl-notes/large-file-perf-baseline.md`
