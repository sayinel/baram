...
<!-- colwidths:165,190,102,103,115,85 -->
...
**Rust IPC (8개):** `plugin_install_stage` / `plugin_install_commit` / `plugin_install_discard` (#261 — 설치는 스테이징 후 원자적 교체), `plugin_uninstall`, `plugin_list_installed`, `plugin_read_manifest`, `plugin_fetch_registry`, `plugin_get_dir`

---

## 16. 버전 히스토리

<!-- colwidths:135,313,60 -->
