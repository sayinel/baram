...
| Phase 3  | Namespace (§61) · Skills Mode (§72) · Plugin Marketplace (§69) | 3    | ✅ 완료           |
| Phase 3  | Tag System · Journal Workspace · Settings Redesign · Folding   | 4    | ✅ 완료           |
| Phase 3  | Vault System (§80-§90)                                         | 11   | ✅ 완료           |
| Phase 3  | 나머지 (Canvas, Agent Mode, Knowledge Q\&A 등)                     | 8    | 미착수            |
| **리팩토링** | 코드 통합 + CSS 디자인 토큰 + 보안 감사                                     | —    | ✅ 완료 (main 머지) |

전체 기능 중 대부분 완료, 남은 8개 미착수 (Canvas, Agent Mode, Knowledge Q\&A, LLM Simulation, MCP, Custom AI Plugin API, Real-time Collaboration, Mobile).

> **리팩토링 상태**: 코드 통합/리팩토링 + CSS 디자인 토큰 시스템 모두 `main` 머지 완료 (2026-03-15)
...
<!-- colwidths:229,285,83 -->

| 기능                              | 설명                            | 상태   |
| ------------------------------- | ----------------------------- | ---- |
| ~~**§69 Plugin Marketplace**~~  | ~~커뮤니티 플러그인, capability 게이팅~~ | ✅ 완료 |
...
<!-- colwidths:218,220,83 -->

| 기능                                | 설명                         | 상태   |
| --------------------------------- | -------------------------- | ---- |
| ~~**§72 Skills-Dedicated Mode**~~ | ~~LLM Skills 편집 전용 UI 모드~~ | ✅ 완료 |
