...
**Design spec:** `dev/design/part13-zettelkasten-space.md` §94 (identity/creation), §96 (promote), §99 (capture migration). Prereq landed: Plan 1 (registry + zettel scaffold, settings `zettelkastenEnabled`/`zettelkastenDirectory`, `ensureZettelkastenScaffold`, `resolveZettelDir`).
