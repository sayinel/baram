...
**Design doc:** `dev/design/part12-vault-system.md`
...
- Modify: `dev/design/part12-vault-system.md` (mark M1 status)
...
In `dev/design/part12-vault-system.md` §12.13, update M1 status to "진행 중" or "완료" as appropriate.

- [ ] **Step 3: Commit**

```bash
git add CLAUDE.md dev/design/part12-vault-system.md
